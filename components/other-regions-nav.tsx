  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="relative z-10 mb-5 pe-9 text-[17px] leading-[1.25] font-semibold tracking-[-0.01em]">
          {region.name}
        </span>
